...
# . (nokta) neyi temsil eder?

./ → Bulunduğun dizin

. → “Bu dizinin içindekiler”

./designer/. → “designer dizininin içindekiler”

Komut	                                   Ne yapar
cp -R ./designer /var/www/html	           designer klasörünü olduğu gibi kopyalar
cp -R ./designer/. /var/www/html	       designer klasörünün içindekileri kopyalar
